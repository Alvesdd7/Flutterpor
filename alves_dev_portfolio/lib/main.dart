...
class AppLinks {
  // Troque somente estes links pelos seus links reais.
  static const github = 'https://github.com/SEU_USUARIO';
  static const instagram = 'https://www.instagram.com/joaoalvesp.dev/';
  static const whatsapp = 'https://wa.me/5517991656885';

  static const jarvis = 'https://github.com/SEU_USUARIO/jarvis-arduino';
  static const pulseiras = 'https://github.com/SEU_USUARIO/loja-pulseiras';
  static const financas = 'https://github.com/SEU_USUARIO/financas-domesticas';
}
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const SectionTitle(
          label: 'PROJETOS',
          title: 'Coisas que estou construindo.',
          description:
              'Alguns projetos utilizados para praticar Flutter, integração com serviços e desenvolvimento de aplicações.',
        ),
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            if (constraints.maxWidth >= 1050) {
              largura = (constraints.maxWidth - 48) / 3;
            } else if (constraints.maxWidth >= 680) {
              largura = (constraints.maxWidth - 24) / 2;
            } else {
            ...
            return Wrap(
              ...
              children: [
                RevealOnScroll(
                  ...
                  child: ProjectCard(
                    width: largura,
                    title: 'Jarvis + Arduino',
                    description:
                        'Projeto de automação integrando Flutter e Arduino com comandos, rotinas e controle de hardware.',
                    technologies: const ['Flutter', 'Dart', 'Arduino', 'C++'],
                    icon: Icons.smart_toy_rounded,
                    previewColor: const Color(0xFF312E81),
                    onProject: () => onOpen(AppLinks.jarvis),
                    onGithub: () => onOpen(AppLinks.jarvis),
                  ),
                ),
                RevealOnScroll(
                  delay: 180.ms,
                  child: ProjectCard(
                    width: largura,
                    title: 'Loja de Pulseiras',
                    description:
                        'Aplicativo de vendas com design moderno, navegação, produtos e foco em uma experiência visual agradável.',
                    technologies: const ['Flutter', 'Dart', 'UI/UX'],
                    icon: Icons.shopping_bag_outlined,
                    previewColor: const Color(0xFF7C3AED),
                    onProject: () => onOpen(AppLinks.pulseiras),
                    onGithub: () => onOpen(AppLinks.pulseiras),
                  ),
                ),
                RevealOnScroll(
                  delay: 280.ms,
                  child: ProjectCard(
                    ...
                    description:
                        'Aplicativo para organização financeira, controle de gastos e gerenciamento de informações domésticas.',
                    technologies: const ['Flutter', 'Dart', 'Azure'],
                    icon: Icons.account_balance_wallet_outlined,
                    previewColor: const Color(0xFF1D4ED8),
                    onProject: () => onOpen(AppLinks.financas),
                    onGithub: () => onOpen(AppLinks.financas),
                  ),
                ),
              ],
            );
